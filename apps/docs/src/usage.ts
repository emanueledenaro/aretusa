export const usage: Record<string,string> = {
  ...
  "navigation-menu": "<NavigationMenu label=\"Site\" items={[{label:\"Projects\",href:\"/projects\",active:true},{label:\"Archive\",items:[{label:\"Letters\",href:\"/archive/letters\",description:\"Transcribed and searchable.\"}]},{label:\"About\",href:\"/about\"}]} />",
