...
Bring Accordion to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Align headings, indicators and expanded content with consistent rhythm.
- [ ] Verify keyboard controls, expanded state and the selected expansion mode.
- [ ] Test long headings, nested forms and reduced motion.
