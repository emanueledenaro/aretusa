...
Bring Attachment to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Design filename, type, size/status and remove/download actions where supported.
- [ ] Give actions explicit names and avoid accidental parent form submission.
- [ ] Test long filenames, upload/error states and mobile target sizing.
