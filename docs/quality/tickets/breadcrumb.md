...
Bring Breadcrumb to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Distinguish current page, ancestors and separators without visual noise.
- [ ] Preserve ordered navigation semantics and meaningful link names.
- [ ] Collapse or wrap long hierarchies intentionally on mobile.
