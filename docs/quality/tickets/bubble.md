...
Bring Bubble to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Define incoming/outgoing alignment, readable measure and content spacing.
- [ ] Keep author and message meaning available without color-only distinction.
- [ ] Test long words, links, code and narrow containers.
