...
Bring Chart to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Tune axes, palette, legends, tooltips and chart-area rhythm across supported types.
- [ ] Provide accessible data alternatives and interaction without mouse-only information.
- [ ] Test empty/small/large series, narrow widths, dark mode and reduced motion.
...
Prerequisite items: table. Native blocking links will be added after the full catalog is registered.
