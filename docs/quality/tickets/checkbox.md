...
Bring Checkbox to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Align box, label, help text and indeterminate/checked/disabled states.
- [ ] Preserve explicit IDs, label activation, form value and caller event behavior.
- [ ] Test multiline labels, Field errors, keyboard and touch.
