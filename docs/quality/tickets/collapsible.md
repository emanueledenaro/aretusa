...
Bring Collapsible to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Provide a clear trigger and measured reveal spacing.
- [ ] Verify expanded state, keyboard and focus when content disappears.
- [ ] Test long hidden content and reduced motion without layout breakage.
