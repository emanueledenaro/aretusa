...
Bring ctablock to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Make one primary next step clear without excessive decoration.
- [ ] Preserve action semantics and loading/disabled states.
- [ ] Test multiline headings and touch-size actions on mobile.
...
Prerequisite items: button, typography. Native blocking links will be added after the full catalog is registered.

## Evidence

Status remains implemented until behavior, visual and consumer gates have evidence. Use docs/quality/evidence-template.md.

Aretusa-Item: ctablock
