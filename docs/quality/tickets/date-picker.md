...
Bring Date Picker to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Design input, selected date, clear action and calendar surface as one control.
- [ ] Verify manual entry, invalid dates, locale presentation and keyboard selection.
- [ ] Test mobile keyboard, narrow popover placement and Field error association.
...
Prerequisite items: calendar, input, popover. Native blocking links will be added after the full catalog is registered.

## Evidence

Status remains implemented until behavior, visual and consumer gates have evidence. Use docs/quality/evidence-template.md.

Aretusa-Item: date-picker
