...
Bring Direction to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Propagate text direction and logical spacing into nested components.
- [ ] Verify portaled overlays and navigation use the intended RTL direction.
- [ ] Test mixed LTR/RTL text, icons and controls in constrained layouts.
