...
Bring Drawer to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Define mobile sheet anatomy, handle/close affordance and action placement.
- [ ] Verify dismissal, focus management and non-drag alternatives for any gestures.
- [ ] Test tall content, keyboard appearance, orientation changes and nested controls.
...
Prerequisite items: dialog. Native blocking links will be added after the full catalog is registered.
