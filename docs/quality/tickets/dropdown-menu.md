...
Bring Dropdown Menu to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Define grouped actions, icons, shortcuts, submenus and destructive states where supported.
- [ ] Verify keyboard navigation, disabled items, selection and focus return.
- [ ] Test long labels, scroll, touch and trigger/menu placement inside overlays.
...
Prerequisite items: button. Native blocking links will be added after the full catalog is registered.

## Evidence

Status remains implemented until behavior, visual and consumer gates have evidence. Use docs/quality/evidence-template.md.

Aretusa-Item: dropdown-menu
