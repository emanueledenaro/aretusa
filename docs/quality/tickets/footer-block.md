...
Bring footer-block to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Keep identity, legal/support links and grouped navigation legible.
- [ ] Preserve link semantics and a predictable mobile order.
- [ ] Test long links, translation-length copy and narrow widths.
