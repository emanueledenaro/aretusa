...
Bring form-block to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Compose label, control, hint/error and submit feedback consistently.
- [ ] Verify real validation, loading, success/error callbacks and form semantics.
- [ ] Test keyboard, mobile input, focus-to-error and short viewports.
