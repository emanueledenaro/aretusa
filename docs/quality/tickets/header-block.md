...
Bring header-block to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Review wordmark, navigation, active state and action hierarchy.
- [ ] Use mobile disclosure with focus and escape behavior; keep every destination reachable.
- [ ] Test long product names, narrow widths, zoom and sticky-header collisions.
...
Prerequisite items: navigation-menu, button. Native blocking links will be added after the full catalog is registered.

## Evidence

Status remains implemented until behavior, visual and consumer gates have evidence. Use docs/quality/evidence-template.md.

Aretusa-Item: header-block
