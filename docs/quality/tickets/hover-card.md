...
Bring Hover Card to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Make supporting information legible with stable placement and restrained motion.
- [ ] Keep essential actions/content available without hover.
- [ ] Verify pointer transition, focus alternatives, collisions and narrow screens.
