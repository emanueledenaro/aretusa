...
Bring Kbd to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Balance keycap typography, border and baseline within text and controls.
- [ ] Use real keyboard semantics and document platform-specific shortcut labels.
- [ ] Test multiline shortcut hints and high contrast.
