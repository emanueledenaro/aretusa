...
Bring Marker to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Separate time or state boundaries with quiet but legible hierarchy.
- [ ] Use appropriate semantics without repetitive live announcements.
- [ ] Test long labels and narrow conversation widths.
