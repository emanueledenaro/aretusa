...
Bring Message to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Align author, metadata, content and actions without visual clutter.
- [ ] Preserve meaningful timestamps, action labels and message semantics.
- [ ] Test long content, attachments and narrow layouts.
