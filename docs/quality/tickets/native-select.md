...
Bring Native Select to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Refine spacing and alignment while respecting platform control behavior.
- [ ] Preserve selected, disabled, required and invalid semantics in forms.
- [ ] Test long options, mobile picker behavior and Field descriptions.
