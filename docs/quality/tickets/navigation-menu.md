...
Bring Navigation Menu to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Design active links, grouped content and responsive navigation.
- [ ] Preserve link semantics and predictable keyboard behavior.
- [ ] Test mobile disclosure, long labels, nested content and real destinations.
