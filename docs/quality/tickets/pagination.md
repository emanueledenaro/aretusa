...
Bring Pagination to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Make position, total, previous/next and edge-disabled states clear.
- [ ] Handle zero/one/many pages, page changes and announced position.
- [ ] Test large page counts and mobile layout without squeezing controls.
