...
Bring Popover to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Align trigger and content with predictable padding and dismissal.
- [ ] Verify focus behavior, Escape, outside press and interactive child controls.
- [ ] Test viewport collisions, long content and nesting inside a dialog.
