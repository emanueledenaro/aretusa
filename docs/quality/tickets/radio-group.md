...
Bring Radio Group to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Balance control, label and supporting text in vertical and card variants.
- [ ] Verify one selection, form values, explicit labels and arrow-key navigation.
- [ ] Test disabled choices, long descriptions and touch targets.
