...
Bring Resizable to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Make the handle visible and preserve useful minimum pane sizes.
- [ ] Verify pointer resizing and keyboard/non-drag alternatives with announced values.
- [ ] Test touch, narrow parents, orientation and content overflow.
