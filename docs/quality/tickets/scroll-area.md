...
Bring Scroll Area to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Provide clear scroll affordances without obscuring content.
- [ ] Verify keyboard scrolling, focusable descendants and nested scroll behavior.
- [ ] Test both axes, long content, touch and bounded dimensions.
