...
Bring Separator to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Use spacing and contrast appropriate to horizontal and vertical grouping.
- [ ] Distinguish decorative separators from meaningful semantic separators.
- [ ] Verify flexible layouts and bounded vertical sizing.
