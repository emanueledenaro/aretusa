...
Bring Sheet to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Define edge placement, header, body and footer across sizes.
- [ ] Verify document scroll handling, Escape and focus restoration.
- [ ] Test safe areas, keyboard, small heights and nested popups.
