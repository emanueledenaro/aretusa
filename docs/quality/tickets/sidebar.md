...
Bring Sidebar to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Design active item, groups, collapsed mode and content alignment.
- [ ] Preserve navigation semantics, focus and state across expansion.
- [ ] Use a mobile-first drawer/disclosure pattern without hiding essential destinations.
...
Prerequisite items: navigation-menu. Native blocking links will be added after the full catalog is registered.

## Evidence

Status remains implemented until behavior, visual and consumer gates have evidence. Use docs/quality/evidence-template.md.

Aretusa-Item: sidebar
