...
Bring signup-block to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Make account-creation requirements and validation clear.
- [ ] Verify valid/invalid/pending/rejected outcomes with correct input semantics.
- [ ] Test long labels, mobile keyboard and accessible error association.
