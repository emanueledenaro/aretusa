...
Bring Slider to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Align track, thumb, labels and value feedback across orientations.
- [ ] Verify keyboard steps, bounds, range thumbs and pointer interaction.
- [ ] Test touch alternatives, label announcements, disabled state and narrow layouts.
