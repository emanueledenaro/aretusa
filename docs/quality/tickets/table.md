...
Bring Table to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Refine caption, headers, row rhythm and numeric alignment.
- [ ] Preserve table semantics and clarify interactive row actions.
- [ ] Test long cells, empty data, zoom and bounded horizontal scrolling.
