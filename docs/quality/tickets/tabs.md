...
Bring Tabs to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Balance active indicator, labels and panel spacing across densities.
- [ ] Verify roving focus, arrow keys, Home/End and panel association.
- [ ] Test overflow, long labels, controlled state and mobile access.
