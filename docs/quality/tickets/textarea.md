...
Bring Textarea to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Review text rhythm, placeholder, resize affordance and error placement.
- [ ] Preserve native input/form behavior and support controlled values.
- [ ] Test long content, mobile keyboard, resizing and minimum/maximum height.
