...
Bring Typography to the Aretusa design and code quality contract, from rendered behavior through documented, installable source. Existing code is a starting point, not evidence of completion.

## Component-specific scenarios

- [ ] Review optical weight, tracking, line height and heading/body hierarchy.
- [ ] Preserve semantic heading levels and readable link/focus treatments.
- [ ] Test 200% text zoom, long words, narrow measure and font fallback.
